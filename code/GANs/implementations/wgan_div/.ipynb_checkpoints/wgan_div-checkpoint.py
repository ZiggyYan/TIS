...
os.makedirs("./Dataset/BUSB/generated/WGAN_DIV/", exist_ok=True)
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if i % opt.n_critic == 0:
            ...
            if epoch%opt.save_frequency == 0:
                ...
                save_image(fake_imgs.data[:16], "./Dataset/BUSB/generated/WGAN_DIV/%s.png" % saved_name, nrow=4,normalize=True)
