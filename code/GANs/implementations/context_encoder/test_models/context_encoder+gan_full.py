...
os.makedirs("./Dataset/BUSI_normal/generated/Context_Encoder+GAN_FULL/", exist_ok=True)
...
def save_sample(batches_done):
    ...
    save_image(sample, "./Dataset/BUSI_normal/generated/Context_Encoder+GAN_FULL/%s.png" % batches_done, nrow=6, normalize=True)
...
for epoch in range(opt.n_epochs):
    ...
    for i, (imgs, masked_imgs, masked_parts) in enumerate(dataloader):
        ...
        # print(discriminator(masked_parts).shape)
        # print(discriminator(gen_parts).shape)
        # print(discriminator(masked_parts).dtype)
        # print(discriminator(gen_parts).dtype)
        # print(type(discriminator(masked_parts)))
        # print(type(discriminator(gen_parts)))
        # print(discriminator(masked_parts.detach()).max())
        # print(discriminator(gen_parts).max())
        # print(discriminator(masked_parts.detach()).min())
        # print(discriminator(gen_parts).min())
        # print(valid.shape)
        # print(fake.shape)
        # print(valid.dtype)
        # print(fake.dtype)
