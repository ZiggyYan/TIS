...
def hog(
    ...
    *,
    ...
    # hog_image = None
    # print('SHAPE1',orientation_histogram.shape)
#     if visualize:
...
#                                 int(centre[1] - dr),
#                             )
#                             print('1',int(centre[0] - dc))
#                             print('2',int(centre[1] + dr))
#                             print('3',int(centre[0] + dc))
#                             print('4',int(centre[1] - dr))
#                             hog_image[rr, cc] += orientation_histogram[r, c, o]
#                             # print('ONE BLOCK END')
#         print('SHAPE2',hog_image.shape)
